                  ...
                  <div className="flex flex-col gap-6">
                    <div className="flex flex-col items-center text-center">
                      <div className="flex items-center gap-3">
                        <h1 className="text-5xl font-light text-neutral-900 dark:text-white">
                          Welcome to
                        </h1>
                        <Image
                          src="/logo.svg"
                      ...
                      <p className="text-neutral-500 text-balance dark:text-white/35 text-base">
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                ...
                                className="h-11 px-4 rounded-xl bg-white/80 border border-neutral-200 shadow focus:shadow-md transition-all duration-200 placeholder:text-neutral-400 text-neutral-900 dark:text-white dark:border-accent"
                                {...field}
                              />
                            </FormControl>
                            <FormMessage />
                            ...
                            <FormControl>
                              <div className="relative">
                                <Input
                                  ...
                                  placeholder="********"
                                  className="h-11 px-4 rounded-xl bg-white/80 border border-neutral-200 shadow focus:shadow-md transition-all duration-200 placeholder:text-neutral-400 text-neutral-900 outline-none pr-10 dark:text-white dark:border-accent
                                "
                                  {...field}
                                />
                                <button
